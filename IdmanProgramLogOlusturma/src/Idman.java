...
public class Idman {
    ...
    public void burpeeYap(int sayi){
        ...
        if(burpee_sayisi - sayi < 0){
            System.out.println("Hedeflediğin Burpee Sayisini geçtin.");
            burpee_sayisi = 0;
    ...
    public void pushupYap(int sayi){
        ...
        if(pushup_sayisi - sayi < 0){
            System.out.println("Hedeflediğin Pushup Sayisini geçtin.");
            pushup_sayisi = 0;
    ...
    public void situpYap(int sayi){
        ...
        if(situp_sayisi - sayi < 0){
            System.out.println("Hedeflediğin situp Sayisini geçtin.");
            situp_sayisi = 0;
            System.out.println("Kalan situp : "+pushup_sayisi);
        }
        else{
            situp_sayisi-=sayi;
    ...
    public void squatYap(int sayi){
        ...
        if(squat_sayisi - sayi < 0){
            System.out.println("Hedeflediğin squat Sayisini geçtin.");
            squat_sayisi = 0;
